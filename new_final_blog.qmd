...
A50 = has skipped meals because no foodA66A = experienced homelessness
...
Our project addressed key areas of the current Ignite Afterschool data briefs, but with the constraints of our project we were not able to reproduce all of the data required. In order to complete the briefs one would have to clarify and correct if necessary the
